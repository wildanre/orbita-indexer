import { oftReceived } from "ponder:schema";
import { datetimeFormatter } from "../../helper/datetimeFormatter";
import { dateFormatter } from "../../helper/dateFormatter";
import { timeFormatter } from "../../helper/timeFormatter";

export const handleOFTReceived = async (event: any, context: any, tokenSymbol: string) => {
  await context.db.insert(oftReceived).values({
    id: event.id,
