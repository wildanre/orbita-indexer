import { withdrawLiquidity } from "ponder:schema";
...
export const handleWithdrawLiquidity = async (event: any, context: any) => {
  await context.db.insert(withdrawLiquidity).values({
    id: event.id,
