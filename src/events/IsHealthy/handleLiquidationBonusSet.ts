import { liquidationBonusSet } from "ponder:schema";
import { datetimeFormatter } from "../../helper/datetimeFormatter";
import { dateFormatter } from "../../helper/dateFormatter";
import { timeFormatter } from "../../helper/timeFormatter";

export const handleLiquidationBonusSet = async (event: any, context: any) => {
  await context.db.insert(liquidationBonusSet).values({
    id: event.id,
    lendingPool: event.args.lendingPool,
    bonus: event.args.bonus,
